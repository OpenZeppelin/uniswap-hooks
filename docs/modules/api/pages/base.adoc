...
:xref-BaseCustomAccounting-_getPositionSalt-address-bytes32-: xref:base.adoc#BaseCustomAccounting-_getPositionSalt-address-bytes32-
...
:_getPositionSalt: pass:normal[xref:#BaseCustomAccounting-_getPositionSalt-address-bytes32-[`++_getPositionSalt++`]]
...
* {xref-BaseCustomAccounting-_getPositionSalt-address-bytes32-}[`++_getPositionSalt(sender, salt)++`]
...
[.contract-item]
[[BaseCustomAccounting-_getPositionSalt-address-bytes32-]]
==== `[.contract-item-name]#++_getPositionSalt++#++(address sender, bytes32 salt) → bytes32++` [.item-kind]#internal#

Returns the salt of the position a liquidity modification applies to. Defaults to the hash of
...
Only allow calls for a pool whose `hooks` is this contract.

...
:xref-BaseDynamicAfterFee-_getTargetUnspecified-address-struct-PoolKey-struct-SwapParams-BalanceDelta-bytes-: xref:fee.adoc#BaseDynamicAfterFee-_getTargetUnspecified-address-struct-PoolKey-struct-SwapParams-BalanceDelta-bytes-
...
:xref-BaseHook-NotPoolManager--: xref:base.adoc#BaseHook-NotPoolManager--
:xref-BaseHook-InvalidPool--: xref:base.adoc#BaseHook-InvalidPool--
:BaseHook-_beforeSwap: pass:normal[xref:base.adoc#BaseHook-_beforeSwap-address-struct-PoolKey-struct-SwapParams-bytes-[`BaseHook._beforeSwap`]]
= Fee
...
:_getTargetUnspecified: pass:normal[xref:#BaseDynamicAfterFee-_getTargetUnspecified-address-struct-PoolKey-struct-SwapParams-BalanceDelta-bytes-[`++_getTargetUnspecified++`]]
...
* {xref-BaseDynamicAfterFee-_getTargetUnspecified-address-struct-PoolKey-struct-SwapParams-BalanceDelta-bytes-}[`++_getTargetUnspecified(sender, key, params, delta, hookData)++`]
...
[.contract-item]
[[BaseDynamicAfterFee-_getTargetUnspecified-address-struct-PoolKey-struct-SwapParams-BalanceDelta-bytes-]]
==== `[.contract-item-name]#++_getTargetUnspecified++#++(address sender, struct PoolKey key, struct SwapParams params, BalanceDelta delta, bytes hookData) → uint256 targetUnspecifiedAmount, bool applyTarget++` [.item-kind]#internal#

Return the target unspecified amount to be enforced on the swap that `delta` reports.
...
Set the hook permissions, specifically {afterSwap} and {afterSwapReturnDelta}.

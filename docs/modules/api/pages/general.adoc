...
:xref-LimitOrderHook-_recordTickLowerLast-struct-PoolKey-: xref:general.adoc#LimitOrderHook-_recordTickLowerLast-struct-PoolKey-
...
:xref-LimitOrderHook-_fillCrossedOrders-struct-PoolKey-: xref:general.adoc#LimitOrderHook-_fillCrossedOrders-struct-PoolKey-
...
:xref-LimitOrderHook-_hasOrderAtTick-PoolId-int24-int24-bool-: xref:general.adoc#LimitOrderHook-_hasOrderAtTick-PoolId-int24-int24-bool-
...
:_recordTickLowerLast: pass:normal[xref:#LimitOrderHook-_recordTickLowerLast-struct-PoolKey-[`++_recordTickLowerLast++`]]
...
:_fillCrossedOrders: pass:normal[xref:#LimitOrderHook-_fillCrossedOrders-struct-PoolKey-[`++_fillCrossedOrders++`]]
...
:_hasOrderAtTick: pass:normal[xref:#LimitOrderHook-_hasOrderAtTick-PoolId-int24-int24-bool-[`++_hasOrderAtTick++`]]
...
.Functions
--
* {xref-LimitOrderHook-_afterInitialize-address-struct-PoolKey-uint160-int24-}[`++_afterInitialize(, key, , )++`]
* {xref-LimitOrderHook-_recordTickLowerLast-struct-PoolKey-}[`++_recordTickLowerLast(key)++`]
* {xref-LimitOrderHook-_afterSwap-address-struct-PoolKey-struct-SwapParams-BalanceDelta-bytes-}[`++_afterSwap(, key, , , )++`]
...
* {xref-LimitOrderHook-_fillCrossedOrders-struct-PoolKey-}[`++_fillCrossedOrders(key)++`]
...
* {xref-LimitOrderHook-_hasOrderAtTick-PoolId-int24-int24-bool-}[`++_hasOrderAtTick(poolId, tickSpacing, tickLower, zeroForOne)++`]
...
[.contract-item]
[[LimitOrderHook-_recordTickLowerLast-struct-PoolKey-]]
==== `[.contract-item-name]#++_recordTickLowerLast++#++(struct PoolKey key)++` [.item-kind]#internal#

Records the tick `key` currently sits at as the baseline the next crossing is measured from,
...
[.contract-item]
[[LimitOrderHook-_fillCrossedOrders-struct-PoolKey-]]
==== `[.contract-item-name]#++_fillCrossedOrders++#++(struct PoolKey key)++` [.item-kind]#internal#
...
[.contract-item]
[[LimitOrderHook-_hasOrderAtTick-PoolId-int24-int24-bool-]]
==== `[.contract-item-name]#++_hasOrderAtTick++#++(PoolId poolId, int24 tickSpacing, int24 tickLower, bool zeroForOne) → bool++` [.item-kind]#internal#

Returns whether `tickLower` is recorded as holding a live order in direction `zeroForOne`.

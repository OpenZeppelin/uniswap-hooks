...
:xref-BaseOracleHook-InvalidMaxAbsTickDelta--: xref:oracles.adoc#BaseOracleHook-InvalidMaxAbsTickDelta--
...
:V3OracleAdapter: pass:normal[xref:oracles.adoc#V3OracleAdapter[`V3OracleAdapter`]]
:V3TruncatedOracleAdapter: pass:normal[xref:oracles.adoc#V3TruncatedOracleAdapter[`V3TruncatedOracleAdapter`]]
...
:xref-BaseHook-NotPoolManager--: xref:base.adoc#BaseHook-NotPoolManager--
:xref-BaseHook-InvalidPool--: xref:base.adoc#BaseHook-InvalidPool--
:BaseOracleHook-constructor: pass:normal[xref:oracles.adoc#BaseOracleHook-constructor-int24-[`BaseOracleHook.constructor`]]
:BaseOracleHook: pass:normal[xref:oracles.adoc#BaseOracleHook[`BaseOracleHook`]]
:xref-V3OracleAdapter-constructor-contract-IPoolManager-contract-BaseOracleHook-PoolId-: xref:oracles.adoc#V3OracleAdapter-constructor-contract-IPoolManager-contract-BaseOracleHook-PoolId-
:xref-V3OracleAdapter-slot0--: xref:oracles.adoc#V3OracleAdapter-slot0--
:xref-V3OracleAdapter-observations-uint256-: xref:oracles.adoc#V3OracleAdapter-observations-uint256-
:xref-V3OracleAdapter-observe-uint32---: xref:oracles.adoc#V3OracleAdapter-observe-uint32---
:xref-V3OracleAdapter-increaseObservationCardinalityNext-uint16-: xref:oracles.adoc#V3OracleAdapter-increaseObservationCardinalityNext-uint16-
:xref-V3OracleAdapter-baseOracleHook-contract-BaseOracleHook: xref:oracles.adoc#V3OracleAdapter-baseOracleHook-contract-BaseOracleHook
:xref-V3OracleAdapter-manager-contract-IPoolManager: xref:oracles.adoc#V3OracleAdapter-manager-contract-IPoolManager
:xref-V3OracleAdapter-poolId-PoolId: xref:oracles.adoc#V3OracleAdapter-poolId-PoolId
:xref-V3OracleAdapter-V3OracleAdapterIndexOutOfRange--: xref:oracles.adoc#V3OracleAdapter-V3OracleAdapterIndexOutOfRange--
:BaseOracleHook: pass:normal[xref:oracles.adoc#BaseOracleHook[`BaseOracleHook`]]
:xref-V3TruncatedOracleAdapter-constructor-contract-IPoolManager-contract-BaseOracleHook-PoolId-: xref:oracles.adoc#V3TruncatedOracleAdapter-constructor-contract-IPoolManager-contract-BaseOracleHook-PoolId-
:xref-V3TruncatedOracleAdapter-slot0--: xref:oracles.adoc#V3TruncatedOracleAdapter-slot0--
:xref-V3TruncatedOracleAdapter-observations-uint256-: xref:oracles.adoc#V3TruncatedOracleAdapter-observations-uint256-
:xref-V3TruncatedOracleAdapter-observe-uint32---: xref:oracles.adoc#V3TruncatedOracleAdapter-observe-uint32---
:xref-V3TruncatedOracleAdapter-increaseObservationCardinalityNext-uint16-: xref:oracles.adoc#V3TruncatedOracleAdapter-increaseObservationCardinalityNext-uint16-
:xref-V3TruncatedOracleAdapter-baseOracleHook-contract-BaseOracleHook: xref:oracles.adoc#V3TruncatedOracleAdapter-baseOracleHook-contract-BaseOracleHook
:xref-V3TruncatedOracleAdapter-manager-contract-IPoolManager: xref:oracles.adoc#V3TruncatedOracleAdapter-manager-contract-IPoolManager
:xref-V3TruncatedOracleAdapter-poolId-PoolId: xref:oracles.adoc#V3TruncatedOracleAdapter-poolId-PoolId
:xref-V3TruncatedOracleAdapter-V3TruncatedOracleAdapterIndexOutOfRange--: xref:oracles.adoc#V3TruncatedOracleAdapter-V3TruncatedOracleAdapterIndexOutOfRange--
= Oracles
...
:InvalidMaxAbsTickDelta: pass:normal[xref:#BaseOracleHook-InvalidMaxAbsTickDelta--[`++InvalidMaxAbsTickDelta++`]]
...
* {xref-BaseOracleHook-InvalidMaxAbsTickDelta--}[`++InvalidMaxAbsTickDelta()++`]
...
Sets the maximum absolute tick delta for the truncated oracle. Reverts with {InvalidMaxAbsTickDelta} if it is not positive.
...
Increase the maximum number of observations that the oracle of `underlyingPoolId` can store.
...
The pool was not initialized with this hook, so it has no recorded observations

[.contract-item]
[[BaseOracleHook-InvalidMaxAbsTickDelta--]]
==== `[.contract-item-name]#++InvalidMaxAbsTickDelta++#++()++` [.item-kind]#error#

The maximum absolute tick delta is not positive
...
* {xref-OracleHookWithV3Adapters-_afterInitialize-address-struct-PoolKey-uint160-int24-}[`++_afterInitialize(sender, key, sqrtPriceX96, tick)++`]
...
Sets the maximum absolute tick delta for the truncated oracle. See {BaseOracleHook-constructor}.

[.contract-item]
[[OracleHookWithV3Adapters-_afterInitialize-address-struct-PoolKey-uint160-int24-]]
==== `[.contract-item-name]#++_afterInitialize++#++(address sender, struct PoolKey key, uint160 sqrtPriceX96, int24 tick) → bytes4++` [.item-kind]#internal#
...
:V3OracleAdapterIndexOutOfRange: pass:normal[xref:#V3OracleAdapter-V3OracleAdapterIndexOutOfRange--[`++V3OracleAdapterIndexOutOfRange++`]]
:baseOracleHook: pass:normal[xref:#V3OracleAdapter-baseOracleHook-contract-BaseOracleHook[`++baseOracleHook++`]]
:manager: pass:normal[xref:#V3OracleAdapter-manager-contract-IPoolManager[`++manager++`]]
:poolId: pass:normal[xref:#V3OracleAdapter-poolId-PoolId[`++poolId++`]]
:constructor: pass:normal[xref:#V3OracleAdapter-constructor-contract-IPoolManager-contract-BaseOracleHook-PoolId-[`++constructor++`]]
:slot0: pass:normal[xref:#V3OracleAdapter-slot0--[`++slot0++`]]
:observations: pass:normal[xref:#V3OracleAdapter-observations-uint256-[`++observations++`]]
:observe: pass:normal[xref:#V3OracleAdapter-observe-uint32---[`++observe++`]]
:increaseObservationCardinalityNext: pass:normal[xref:#V3OracleAdapter-increaseObservationCardinalityNext-uint16-[`++increaseObservationCardinalityNext++`]]

[.contract]
[[V3OracleAdapter]]
=== `++V3OracleAdapter++` link:https://github.com/OpenZeppelin/uniswap-hooks/blob/master/src/oracles/panoptic/adapters/V3OracleAdapter.sol[{github-icon},role=heading-link]

[.hljs-theme-light.nopadding]
```solidity
import "uniswap-hooks/src/oracles/panoptic/adapters/V3OracleAdapter.sol";
```

Uniswap V3-compatible oracle interface for a pool's observations recorded by a {BaseOracleHook}.
...
.Functions
--
* {xref-V3OracleAdapter-constructor-contract-IPoolManager-contract-BaseOracleHook-PoolId-}[`++constructor(_manager, _baseOracleHook, _poolId)++`]
* {xref-V3OracleAdapter-slot0--}[`++slot0()++`]
* {xref-V3OracleAdapter-observations-uint256-}[`++observations(index)++`]
* {xref-V3OracleAdapter-observe-uint32---}[`++observe(secondsAgos)++`]
* {xref-V3OracleAdapter-increaseObservationCardinalityNext-uint16-}[`++increaseObservationCardinalityNext(observationCardinalityNext)++`]
* {xref-V3OracleAdapter-baseOracleHook-contract-BaseOracleHook}[`++baseOracleHook()++`]
* {xref-V3OracleAdapter-manager-contract-IPoolManager}[`++manager()++`]
* {xref-V3OracleAdapter-poolId-PoolId}[`++poolId()++`]
...
.Errors
--
* {xref-V3OracleAdapter-V3OracleAdapterIndexOutOfRange--}[`++V3OracleAdapterIndexOutOfRange()++`]

--

[.contract-item]
[[V3OracleAdapter-constructor-contract-IPoolManager-contract-BaseOracleHook-PoolId-]]
==== `[.contract-item-name]#++constructor++#++(contract IPoolManager _manager, contract BaseOracleHook _baseOracleHook, PoolId _poolId)++` [.item-kind]#public#

Initializes the adapter with the BaseOracleHook contract and pool ID.

[.contract-item]
[[V3OracleAdapter-slot0--]]
==== `[.contract-item-name]#++slot0++#++() → uint160 sqrtPriceX96, int24 tick, uint16 observationIndex, uint16 observationCardinality, uint16 observationCardinalityNext, uint8 feeProtocol, bool unlocked++` [.item-kind]#external#

Emulates the behavior of the exposed zeroth slot of a Uniswap V3 pool.

NOTE: `unlocked` is always `true` and must not gate a reentrancy check.

[.contract-item]
[[V3OracleAdapter-observations-uint256-]]
==== `[.contract-item-name]#++observations++#++(uint256 index) → uint32 blockTimestamp, int56 tickCumulative, uint160 secondsPerLiquidityCumulativeX128, bool initialized++` [.item-kind]#external#

Returns data about a specific observation index.

[.contract-item]
[[V3OracleAdapter-observe-uint32---]]
==== `[.contract-item-name]#++observe++#++(uint32[] secondsAgos) → int56[] tickCumulatives, uint160[] secondsPerLiquidityCumulativeX128s++` [.item-kind]#external#

Returns the cumulative tick values as of each timestamp `secondsAgo` from the current block timestamp.

[.contract-item]
[[V3OracleAdapter-increaseObservationCardinalityNext-uint16-]]
==== `[.contract-item-name]#++increaseObservationCardinalityNext++#++(uint16 observationCardinalityNext)++` [.item-kind]#external#

Increases the maximum number of price observations that this oracle will store.

[.contract-item]
[[V3OracleAdapter-baseOracleHook-contract-BaseOracleHook]]
==== `[.contract-item-name]#++baseOracleHook++#++() → contract BaseOracleHook++` [.item-kind]#public#

The BaseOracleHook contract this adapter interacts with.

[.contract-item]
[[V3OracleAdapter-manager-contract-IPoolManager]]
==== `[.contract-item-name]#++manager++#++() → contract IPoolManager++` [.item-kind]#public#

The canonical Uniswap V4 pool manager.

[.contract-item]
[[V3OracleAdapter-poolId-PoolId]]
==== `[.contract-item-name]#++poolId++#++() → PoolId++` [.item-kind]#public#

The pool ID of the underlying V4 pool.

[.contract-item]
[[V3OracleAdapter-V3OracleAdapterIndexOutOfRange--]]
==== `[.contract-item-name]#++V3OracleAdapterIndexOutOfRange++#++()++` [.item-kind]#error#

Thrown when `observations(uint256)` is called with an index that does not fit in `uint16`.

:V3TruncatedOracleAdapterIndexOutOfRange: pass:normal[xref:#V3TruncatedOracleAdapter-V3TruncatedOracleAdapterIndexOutOfRange--[`++V3TruncatedOracleAdapterIndexOutOfRange++`]]
:baseOracleHook: pass:normal[xref:#V3TruncatedOracleAdapter-baseOracleHook-contract-BaseOracleHook[`++baseOracleHook++`]]
:manager: pass:normal[xref:#V3TruncatedOracleAdapter-manager-contract-IPoolManager[`++manager++`]]
:poolId: pass:normal[xref:#V3TruncatedOracleAdapter-poolId-PoolId[`++poolId++`]]
:constructor: pass:normal[xref:#V3TruncatedOracleAdapter-constructor-contract-IPoolManager-contract-BaseOracleHook-PoolId-[`++constructor++`]]
:slot0: pass:normal[xref:#V3TruncatedOracleAdapter-slot0--[`++slot0++`]]
:observations: pass:normal[xref:#V3TruncatedOracleAdapter-observations-uint256-[`++observations++`]]
:observe: pass:normal[xref:#V3TruncatedOracleAdapter-observe-uint32---[`++observe++`]]
:increaseObservationCardinalityNext: pass:normal[xref:#V3TruncatedOracleAdapter-increaseObservationCardinalityNext-uint16-[`++increaseObservationCardinalityNext++`]]

[.contract]
[[V3TruncatedOracleAdapter]]
=== `++V3TruncatedOracleAdapter++` link:https://github.com/OpenZeppelin/uniswap-hooks/blob/master/src/oracles/panoptic/adapters/V3TruncatedOracleAdapter.sol[{github-icon},role=heading-link]

[.hljs-theme-light.nopadding]
```solidity
import "uniswap-hooks/src/oracles/panoptic/adapters/V3TruncatedOracleAdapter.sol";
```

Uniswap V3-compatible oracle interface for a pool's truncated observations recorded by a {BaseOracleHook}.
...
.Functions
--
* {xref-V3TruncatedOracleAdapter-constructor-contract-IPoolManager-contract-BaseOracleHook-PoolId-}[`++constructor(_manager, _baseOracleHook, _poolId)++`]
* {xref-V3TruncatedOracleAdapter-slot0--}[`++slot0()++`]
* {xref-V3TruncatedOracleAdapter-observations-uint256-}[`++observations(index)++`]
* {xref-V3TruncatedOracleAdapter-observe-uint32---}[`++observe(secondsAgos)++`]
* {xref-V3TruncatedOracleAdapter-increaseObservationCardinalityNext-uint16-}[`++increaseObservationCardinalityNext(observationCardinalityNext)++`]
* {xref-V3TruncatedOracleAdapter-baseOracleHook-contract-BaseOracleHook}[`++baseOracleHook()++`]
* {xref-V3TruncatedOracleAdapter-manager-contract-IPoolManager}[`++manager()++`]
* {xref-V3TruncatedOracleAdapter-poolId-PoolId}[`++poolId()++`]
...
.Errors
--
* {xref-V3TruncatedOracleAdapter-V3TruncatedOracleAdapterIndexOutOfRange--}[`++V3TruncatedOracleAdapterIndexOutOfRange()++`]

--

[.contract-item]
[[V3TruncatedOracleAdapter-constructor-contract-IPoolManager-contract-BaseOracleHook-PoolId-]]
==== `[.contract-item-name]#++constructor++#++(contract IPoolManager _manager, contract BaseOracleHook _baseOracleHook, PoolId _poolId)++` [.item-kind]#public#

Initializes the adapter with the BaseOracleHook contract and pool ID.

[.contract-item]
[[V3TruncatedOracleAdapter-slot0--]]
==== `[.contract-item-name]#++slot0++#++() → uint160 sqrtPriceX96, int24 tick, uint16 observationIndex, uint16 observationCardinality, uint16 observationCardinalityNext, uint8 feeProtocol, bool unlocked++` [.item-kind]#external#
...
[.contract-item]
[[V3TruncatedOracleAdapter-observations-uint256-]]
==== `[.contract-item-name]#++observations++#++(uint256 index) → uint32 blockTimestamp, int56 tickCumulativeTruncated, uint160 secondsPerLiquidityCumulativeX128, bool initialized++` [.item-kind]#external#

Returns data about a specific observation index.

[.contract-item]
[[V3TruncatedOracleAdapter-observe-uint32---]]
==== `[.contract-item-name]#++observe++#++(uint32[] secondsAgos) → int56[] tickCumulativesTruncated, uint160[] secondsPerLiquidityCumulativeX128s++` [.item-kind]#external#

Returns the truncated cumulative tick values as of each timestamp `secondsAgo` from the current block timestamp.

[.contract-item]
[[V3TruncatedOracleAdapter-increaseObservationCardinalityNext-uint16-]]
==== `[.contract-item-name]#++increaseObservationCardinalityNext++#++(uint16 observationCardinalityNext)++` [.item-kind]#external#

Increases the maximum number of price observations that this oracle will store.

[.contract-item]
[[V3TruncatedOracleAdapter-baseOracleHook-contract-BaseOracleHook]]
==== `[.contract-item-name]#++baseOracleHook++#++() → contract BaseOracleHook++` [.item-kind]#public#

The BaseOracleHook contract this adapter interacts with.

[.contract-item]
[[V3TruncatedOracleAdapter-manager-contract-IPoolManager]]
==== `[.contract-item-name]#++manager++#++() → contract IPoolManager++` [.item-kind]#public#

The canonical Uniswap V4 pool manager.

[.contract-item]
[[V3TruncatedOracleAdapter-poolId-PoolId]]
==== `[.contract-item-name]#++poolId++#++() → PoolId++` [.item-kind]#public#

The pool ID of the underlying V4 pool.

[.contract-item]
[[V3TruncatedOracleAdapter-V3TruncatedOracleAdapterIndexOutOfRange--]]
==== `[.contract-item-name]#++V3TruncatedOracleAdapterIndexOutOfRange++#++()++` [.item-kind]#error#
